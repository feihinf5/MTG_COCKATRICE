...
- Enables a turn 3 [**Ernham Djinn**](https://api.scryfall.com/cards/REPLACE_WITH_APPROPRIATE_UUID?format=image) followed by a turn 4 [**Armageddon**](https://api.scryfall.com/cards/REPLACE_WITH_APPROPRIATE_UUID?format=image) using green mana generated creatures
