...
- [**Black Knight**](https://api.scryfall.com/cards/47716cf4-f35c-4613-9686-4e00b5063408?format=image)'s Protection from White immune to [**Swords to Plowshares**](https://api.scryfall.com/cards/REPLACE_WITH_APPROPRIATE_UUID?format=image) and unblockable by [**Kjeldoran Outpost**](https://api.scryfall.com/cards/REPLACE_WITH_APPROPRIATE_UUID?format=image) soldier tokens
